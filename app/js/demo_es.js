...
//
var es = { // this is a global object, so pick a name that represents your view uniquely
  me: 'es', // put the name of the object here too. Makes the rest of the code more generic
...
// TEMPLATE CHART
    {
      ...
      title: { text: 'es Percent Abort 1' },
      xAxis: {
          title: { text: 'Channel' }
      },
      yAxis: {
          title: { text: 'Percent Abort 1' },
      ...
      series: [{
          ...
          name: 'Percent Abort 1',
          data: data[0] // the test-data just happens to match correctly here :-)
