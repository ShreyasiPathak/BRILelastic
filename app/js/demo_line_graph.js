...
//
var line_graph = { // this is a global object, so pick a name that represents your view uniquely
  me: 'line_graph', // put the name of the object here too. Makes the rest of the code more generic
