...
//
var multiple_template = { // this is a global object, so pick a name that represents your view uniquely
  me: 'multiple_template', // put the name of the object here too. Makes the rest of the code more generic
...
//
//  Plot the first chart. Note the 'renderTo' argument. There are divs for up to
//  4 charts, with names ending in '-chart', '-chart2', '-chart3' and '-chart4'
//
//  More can be added later but this is a start
//
...
//
//  Plot the second chart. Note the 'renderTo' argument points to '-chart2'
//
//  The chart plotted here is identical to the one above. It's up to you to
//  make it different :-)
//
    this.chart = new Highcharts.Chart(
// TEMPLATE CHART
    {
      chart: { renderTo: this.me+'-chart2' },
      exporting: {
        buttons: {
          contextButton: {
            enabled: true,
